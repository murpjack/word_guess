...
var $author$project$Main$maxGuesses = 5;
	...
	return _Utils_Tuple2(
		{
			currentGuess: '',
			guesses: _List_Nil,
			history: A2($elm$core$List$repeat, $author$project$Main$maxGuesses, 0),
			message: '',
			played: _List_Nil,
			winStreakBest: 0,
			winStreakCurrent: 0,
...
var $author$project$Main$words = _List_fromArray(
	['water']);
var $author$project$Main$update = F2(
	function (msg, model) {
		if (msg.$ === 'SubmitGuess') {
			var _v1 = $elm$core$List$head($author$project$Main$words);
			if (_v1.$ === 'Just') {
				var w = _v1.a;
				return ((!_Utils_eq(model.currentGuess, w)) && _Utils_eq(
					$elm$core$List$length(model.guesses) - 1,
					$author$project$Main$maxGuesses)) ? _Utils_Tuple2(
					_Utils_update(
						model,
						{
							message: 'too bad. try again tomorrow',
							played: A2($elm$core$List$cons, w, model.played),
							winStreakCurrent: 0
						}),
					$elm$core$Platform$Cmd$none) : (_Utils_eq(model.currentGuess, w) ? _Utils_Tuple2(
					_Utils_update(
						model,
						{
							guesses: A2($elm$core$List$cons, model.currentGuess, model.guesses),
							history: A3(
								$elm_community$list_extra$List$Extra$updateAt,
								$elm$core$List$length(model.guesses),
								$elm$core$Basics$add(1),
								model.history),
							message: 'yay',
							played: A2($elm$core$List$cons, w, model.played),
							winStreakBest: (_Utils_cmp(model.winStreakCurrent + 1, model.winStreakBest) > 0) ? (model.winStreakCurrent + 1) : model.winStreakBest,
...
var $author$project$Main$details = function (s) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text(
						'guesses so far: ' + $elm$core$Debug$toString(
							$elm$core$List$length(s.guesses)))
					])),
				A2(
				$elm$html$Html$div,
				_List_Nil,
				_List_fromArray(
					[
						$elm$html$Html$text(
						'won: ' + $elm$core$Debug$toString(s.won))
					])),
				A2(
				$elm$html$Html$div,
				_List_Nil,
				_List_fromArray(
					[
						$elm$html$Html$text(
						'played: ' + $elm$core$Debug$toString(
							$elm$core$List$length(s.played)))
					])),
				A2(
				$elm$html$Html$div,
				_List_Nil,
				_List_fromArray(
					[
						$elm$html$Html$text(
						'history: ' + $elm$core$Debug$toString(s.history))
					]))
			]));
};
var $author$project$Main$SubmitGuess = {$: 'SubmitGuess'};
var $author$project$Main$TypeLetter = function (a) {
	return {$: 'TypeLetter', a: a};
};
var $author$project$Main$game = function (m) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$value(m.currentGuess),
						$elm$html$Html$Events$onInput($author$project$Main$TypeLetter)
					]),
				_List_Nil),
				A2(
				$elm$html$Html$button,
...
var $author$project$Main$answer = 'water';
var $author$project$Main$Absent = function (a) {
	return {$: 'Absent', a: a};
};
var $author$project$Main$Exact = function (a) {
	return {$: 'Exact', a: a};
};
...
var $author$project$Main$look = F2(
	function (c, _v0) {
		var ls = _v0.a;
		var wd = _v0.b;
		if ($elm$core$List$isEmpty(wd)) {
			return _Utils_Tuple2(ls, _List_Nil);
		} else {
			var _v1 = A2($elm_community$list_extra$List$Extra$splitAt, 1, wd);
			var w = _v1.a;
			var ws = _v1.b;
			var _v2 = $elm$core$List$head(w);
			if (_v2.$ === 'Just') {
				var i = _v2.a;
				return _Utils_eq(i, c) ? _Utils_Tuple2(
					A2(
						$elm$core$List$cons,
						$author$project$Main$Exact(c),
						ls),
					ws) : (A2($elm$core$List$member, c, ws) ? _Utils_Tuple2(
					A2(
						$elm$core$List$cons,
						$author$project$Main$Present(c),
						ls),
					ws) : _Utils_Tuple2(
					A2(
						$elm$core$List$cons,
						$author$project$Main$Absent(c),
						ls),
					ws));
			} else {
				return _Utils_Tuple2(ls, wd);
			}
		}
	});
var $author$project$Main$match = F2(
	function (wd, guess) {
		return A3(
			$elm$core$List$foldr,
			$author$project$Main$look,
			_Utils_Tuple2(
				_List_Nil,
				$elm$core$List$reverse(wd)),
			guess).a;
	});
var $author$project$Main$renderGuess = $elm$core$List$map(
	function (ptn) {
		switch (ptn.$) {
			case 'Exact':
				var c = ptn.a;
			...
			case 'Present':
				...
				return A2(
					...
					_List_fromArray(
						[
							A2($elm$html$Html$Attributes$style, 'color', 'orangered')
						]),
					_List_fromArray(
						[
							$elm$html$Html$text(
...
var $author$project$Main$previousGuess = function (guess) {
	var w = $elm$core$String$toList($author$project$Main$answer);
	var g = $elm$core$String$toList(guess);
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		$author$project$Main$renderGuess(
			A2($author$project$Main$match, w, g)));
};
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$div,
						_List_Nil,
						A2($elm$core$List$map, $author$project$Main$previousGuess, model.guesses)),
...
_Platform_export({'Main':{'init':$author$project$Main$main($elm$json$Json$Decode$value)({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{},"unions":{"Main.Msg":{"args":[],"tags":{"SubmitGuess":[],"TypeLetter":["String.String"]}},"String.String":{"args":[],"tags":{"String":[]}}}}})}});
